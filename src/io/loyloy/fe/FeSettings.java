...
public class FeSettings
{
    ...
    public void onEnable()
    {
        ...
        config.options().header( "Fe Config - loyloy.io\n" +
                "new-player-holdings - The amount of money that players will start out with\n" +
                "prefix - The message prefix\n" +
                "currency - The single and multiple names for the currency\n" +
                "database-type - The type of database used (sqlite, mysql)" );
